# Lab 00 — Environment Setup & Reproducibility
    ...
    ## Learning Objectives
    - Verify Python 3.11 and Jupyter installation
- Create deterministic seeds and smoke tests
- Document environment capture

    ## Reading List
    - Official Gymnasium quickstart
- Python virtual environment documentation
- NAOqi SDK installation notes

    ## Tasks
    1. Execute the notebook `00_setup_environment.ipynb` start-to-finish using the provided kernel.
    ...
    ## Expected Runtime
    - Approximately 5 minutes on a modern laptop (i7/Ryzen, 16 GB RAM).
